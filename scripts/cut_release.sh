...
echo "  6. GitHub Release is published automatically by Release Guard CI on tag push"
echo "     (.github/workflows/release-guard.yml; workflow_dispatch for backfill)"
echo ""
